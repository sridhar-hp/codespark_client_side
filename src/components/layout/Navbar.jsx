            ...
            <div className="flex items-center gap-2 sm:gap-4">
                ...
                <div className="relative" ref={notifRef}>
                    <button
                        ...
                        className={`relative p-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500/50 ${isNotifOpen ? 'bg-[#1F2937] text-white' : 'text-[#9CA3AF] hover:bg-[#1F2937] hover:text-white'
                            }`}
                    ...
                    <div
                        className={`absolute right-0 mt-2 w-80 sm:w-96 bg-[#111827] border border-[#1F2937] rounded-xl shadow-2xl origin-top-right transition-all duration-200 z-50 overflow-hidden ${isNotifOpen ? 'opacity-100 scale-100 visible' : 'opacity-0 scale-95 invisible pointer-events-none'
                            }`}
                    >
                ...
                <div className="relative" ref={profileRef}>
                    ...
                    {/* Profile Menu Panel */}
                    <div
                        className={`absolute right-0 mt-2 w-56 bg-[#111827] border border-[#1F2937] rounded-xl shadow-2xl origin-top-right transition-all duration-200 z-50 overflow-hidden ${isProfileOpen ? 'opacity-100 scale-100 visible' : 'opacity-0 scale-95 invisible pointer-events-none'
                            }`}
                    >
